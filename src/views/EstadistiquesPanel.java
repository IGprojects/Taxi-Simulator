...
public class EstadistiquesPanel extends JPanel {
    ...
    public EstadistiquesPanel(Map<String, Estadistiques> dades) {
        this.dades = dades;
        setLayout(new GridLayout(3, 2, 10, 10)); // 3 files x 2 columnes (6 gràfics màxim)
        afegirGrafics();
    }
    ...
    private static class Grafica extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            // Dibuixar línies guia horitzontals amb valors
            int liniesY = 5;
            ...
            for (Map.Entry<String, Estadistiques> entry : dades.entrySet()) {
                ...
                g2.drawString(label, xs[i] - 20, ys[i] - 10);  // mostra per sobre
                i++;
            }
