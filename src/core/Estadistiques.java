...
public class Estadistiques {
    ...
    public static double getPorcentajeExitoAgregado() {
        if (historialSimulaciones.isEmpty()) return 0;
        
        int totalServidas = 0;
        int totalNoServidas = 0;
        
        for (Estadistiques
 stats : historialSimulaciones) {
 ...
 stats : historialSimulaciones) {
    ...
    // Getters
    public int getPeticionesServidas() { return peticionesServidas; }
    public int getPeticionesNoServidas() { return peticionesNoServidas; }
    public double getTiempoMaximoEspera() { return tiempoMaximoEspera; }
