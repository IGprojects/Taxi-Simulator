/**
 * @interface ILloc
 * @brief Defineix les operacions bàsiques per a qualsevol tipus de localització
 *        al mapa.
 * @details Aquesta interfície especifica els mètodes necessaris per gestionar
 *          la presència de vehicles
 *          en un lloc, ja sigui un punt de càrrega, un pàrquing o un lloc
 *          genèric.
 * 
 * @author Grup b9
 * @version 2025.03.04
 */
public interface ILloc {
